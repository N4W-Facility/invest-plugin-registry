...
* If the submission met all of the above criteria, **Merge the Pull Request**.
* If the submission failed to meet all of the above criteria, leave a comment on the pull
  request, selecting "Request Changes," that:

  * Tags the submitter
  * Include the explanation of which criteria were unmet / which pieces of information
    needed for completing a review were missing
  * Includes the following instructions for the submitter: "Please review the above
